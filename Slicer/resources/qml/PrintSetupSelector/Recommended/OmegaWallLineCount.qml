...
Item
{
    ...
    Cura.IconWithText
    {
        ...
        source: UM.Theme.getIcon("category_shell")
        text: "Wall line count"
    ...
    Item
    {
        ...
        Rectangle
        {
            ...
            TextField
            {
                ...
                text: linesCount.properties.value

                onTextChanged: {
                    linesCount.setPropertyValue("value", input.text)
                }
                ...
                Binding
                {
                    ...
                    value:
                    {
                        return lines_count.properties.value
                    }
            ...
            Label
            {
                ...
                text: {
                    if(linesCount.properties.value == 1){
                        return "layer"
                    }
                    return "layers"
           ...
           property var lines_count : UM.SettingPropertyProvider
            {
                id: linesCount
                containerStackId: Cura.MachineManager.activeStackId
                key: "wall_line_count"
