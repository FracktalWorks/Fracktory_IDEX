...
Item
{
    ...
    Cura.IconWithText
    {
        ...
        source: UM.Theme.getIcon("top_layers")
        text: "Top Layers "
    ...
    Item
    {
        ...
        Rectangle
        {
            ...
            TextField
            {
                ...
                text: topLayers.properties.value

                onTextChanged: {
                    topLayers.setPropertyValue("value", input.text)
                }
                ...
                Binding
                {
                    ...
                    value:
                    {
                        return top_layers.properties.value
                    }
            ...
            Label
            {
                ...
                text: {
                    if(topLayers.properties.value == 1){
                        return "layer"
                    }
                    return "layers"
                }
           ...
           property var top_layers : UM.SettingPropertyProvider
            {
                id: topLayers
                containerStackId: Cura.MachineManager.activeStackId
                key: "top_layers"
